...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-indigo-50/50 text-indigo-950 font-sans selection:bg-indigo-600 selection:text-white">
      
      {/* --- TOP CONTACT BAR --- */}
      <div className="bg-gradient-to-r from-indigo-950 to-indigo-900 text-indigo-100 py-2 px-6">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-lg border-b border-indigo-100 px-6 py-4 transition-all">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <a href="#" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-indigo-500 text-white font-black rounded-lg flex items-center justify-center text-xl shadow-md shadow-indigo-200">
              J
            </div>
            <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white font-bold px-6 py-2.5 rounded-full text-sm transition-all shadow-lg shadow-indigo-600/20 hover:shadow-xl hover:shadow-indigo-600/30 hover:-translate-y-0.5 flex items-center gap-2"
            >
      ...
      <section className="relative pt-12 pb-20 lg:pt-24 lg:pb-32 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 z-10">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-indigo-700 bg-indigo-100 px-4 py-2 rounded-full border border-indigo-200">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-indigo-950 leading-[1.1] tracking-tight">
              Building Spaces That <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-indigo-400">Inspire.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                onClick={() => setIsEstimateModalOpen(true)}
                className="bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white font-bold px-8 py-4 rounded-full text-sm transition-all shadow-xl shadow-indigo-600/20 hover:shadow-2xl hover:shadow-indigo-600/40 hover:-translate-y-1 text-center"
              >
                Start Your Project
              </button>
              <a 
                href="#portfolio"
                className="bg-white hover:bg-indigo-50 text-indigo-900 border border-indigo-200 font-bold px-8 py-4 rounded-full text-sm transition-all text-center shadow-sm"
              >
                View Portfolio
              </a>
            </div>
          ...
          <div className="relative z-10 lg:ml-auto w-full max-w-md">
            <div className="absolute inset-0 bg-indigo-200/50 blur-3xl -z-10 rounded-full"></div>
            <div className="bg-white/90 backdrop-blur-xl border border-indigo-100 p-8 rounded-3xl shadow-2xl shadow-indigo-900/10">
              <h3 className="text-xl font-black text-indigo-950 mb-2">Instant Cost Estimator</h3>
              <p className="text-sm text-indigo-900/60 mb-8">Move the slider to estimate your project cost.</p>

              <div className="space-y-6">
                <div>
                  <div className="flex justify-between text-sm font-bold mb-3">
                    <span className="text-indigo-900/80">Carpet Area</span>
                ...
                <div className="bg-gradient-to-br from-indigo-950 to-indigo-900 text-white p-6 rounded-2xl shadow-inner shadow-indigo-950/50">
                  ...
                  <button 
                    ...
                    className="w-full bg-white hover:bg-indigo-50 text-indigo-700 font-black py-3 rounded-xl transition-colors text-sm shadow-md"
                  >
      ...
      <section id="about" className="py-24 bg-white px-6 border-t border-indigo-100/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {capabilities.map((cap, i) => (
              <div key={i} className="bg-indigo-50/50 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:shadow-indigo-900/5 transition-all duration-300 border border-indigo-100">
                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-indigo-50">
                  {cap.icon}
                </div>
                <h3 className="text-xl font-black text-indigo-950 mb-3">{cap.title}</h3>
                <p className="text-indigo-900/70 leading-relaxed">{cap.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {['All', 'Residential', 'Civil', 'Interiors'].map(filter => (
              <button
                ...
                className={`px-5 py-2.5 text-sm font-bold rounded-full transition-all border ${
                  activeFilter === filter ? 'bg-gradient-to-r from-indigo-600 to-indigo-500 text-white border-transparent shadow-md shadow-indigo-500/30' : 'bg-white text-indigo-900/70 border-indigo-200 hover:bg-indigo-50 hover:text-indigo-900'
                }`}
              >
                {filter}
              </button>
          ...
          {filteredProjects.map((p) => (
            ...
            >
              <div className="h-72 overflow-hidden relative">
                ...
                <div className="absolute top-4 left-4 z-20 bg-white/95 backdrop-blur-sm text-indigo-950 text-xs font-bold px-3 py-1.5 rounded-full shadow-sm">
                  {p.category}
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-sm text-indigo-900/60 flex items-center gap-1"><MapPin className="w-4 h-4 text-indigo-500" /> {p.location}</p>
                  </div>
                  <span className="bg-indigo-50 border border-indigo-100 text-indigo-800 text-xs font-bold px-3 py-1 rounded-full">
                    {p.area}
                  </span>
                </div>
                <p className="text-indigo-900/70 mb-6 line-clamp-2">{p.description}</p>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex justify-center items-center p-4 bg-indigo-950/80 backdrop-blur-sm">
          <div className="bg-white w-full max-w-3xl max-h-[90vh] rounded-3xl overflow-hidden flex flex-col relative shadow-2xl shadow-indigo-950">
            <button 
            ...
            <div className="h-64 sm:h-80 relative shrink-0">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-indigo-950 via-indigo-950/60 to-transparent flex items-end p-8">
            ...
            <div className="p-8 overflow-y-auto flex-1 bg-indigo-50/30">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {selectedProject.features.map((feat, i) => (
                  <div key={i} className="flex items-center gap-3 bg-white p-4 rounded-xl border border-indigo-100 shadow-sm">
                    ...
                    <span className="text-sm font-semibold text-indigo-900">{feat}</span>
                  </div>
                ))}
              </div>

              <div className="bg-gradient-to-br from-indigo-950 to-indigo-900 p-6 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 shadow-inner">
                <div>
                ...
                <button 
                  ...
                  className="w-full sm:w-auto bg-white hover:bg-indigo-50 text-indigo-700 px-6 py-3 rounded-full text-sm font-black transition-all whitespace-nowrap shadow-md"
                >
                  Get Free Estimate
                </button>
              </div>
      ...
      {isEstimateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-indigo-950/80 backdrop-blur-sm">
          <div className="bg-white w-full max-w-md p-8 rounded-3xl relative shadow-2xl shadow-indigo-950">
            <button 
              onClick={() => { setIsEstimateModalOpen(false); setIsLeadSaved(false); }} 
              className="absolute top-6 right-6 text-indigo-300 hover:text-indigo-950 transition-colors"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            {!isLeadSaved ? (
              <>
                ...
                <p className="text-sm text-indigo-900/60 mb-8">Provide your details and we will send you a transparent, itemized quotation.</p>

                <form onSubmit={handleEstimateSubmit} className="space-y-5">
                  <div>
                    <label className="block text-xs font-bold text-indigo-800 uppercase mb-2 ml-1">Full Name</label>
                    <input type="text" required value={leadData.clientName} onChange={e => setLeadData({...leadData, clientName: e.target.value})} placeholder="e.g. Ramesh Varma" className="w-full px-5 py-4 bg-indigo-50/50 border border-indigo-200 text-indigo-950 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all placeholder:text-indigo-900/30" />
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-indigo-800 uppercase mb-2 ml-1">Phone</label>
                      <input type="tel" required value={leadData.phone} onChange={e => setLeadData({...leadData, phone: e.target.value})} placeholder="+91 98765..." className="w-full px-5 py-4 bg-indigo-50/50 border border-indigo-200 text-indigo-950 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all placeholder:text-indigo-900/30" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-indigo-800 uppercase mb-2 ml-1">Area (Sq.Ft)</label>
                      <input type="number" required value={leadData.sqft} onChange={e => setLeadData({...leadData, sqft: e.target.value})} placeholder="2500" className="w-full px-5 py-4 bg-indigo-50/50 border border-indigo-200 text-indigo-950 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all placeholder:text-indigo-900/30" />
                    </div>
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-indigo-800 uppercase mb-2 ml-1">Project Type</label>
                    <select value={leadData.projectType} onChange={e => setLeadData({...leadData, projectType: e.target.value})} className="w-full px-5 py-4 bg-indigo-50/50 border border-indigo-200 text-indigo-950 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all cursor-pointer">
                  ...
                  <button type="submit" disabled={loading} className="w-full py-4 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white font-black rounded-full transition-all mt-4 shadow-lg shadow-indigo-600/30 hover:shadow-xl hover:shadow-indigo-600/40 hover:-translate-y-0.5">
              ...
              <div className="py-10 text-center space-y-4">
                ...
                <p className="text-sm text-indigo-600/80 pt-4 border-t border-indigo-100 mt-6">Our planning team will call {leadData.phone} shortly to discuss precise material specifications.</p>
              </div>
            )}
          </div>
        </div>
      ...
      {/* --- CTA SECTION --- */}
      <section className="py-24 bg-gradient-to-br from-indigo-800 via-indigo-700 to-indigo-900 px-6 text-center border-t border-indigo-800">
        <div className="max-w-3xl mx-auto">
          ...
          <button 
            onClick={() => setIsEstimateModalOpen(true)}
            className="bg-white hover:bg-indigo-50 text-indigo-800 font-black px-10 py-5 rounded-full text-lg shadow-xl shadow-indigo-900/50 hover:scale-105 transition-transform"
          >
      ...
      <footer id="contact" className="bg-indigo-950 text-indigo-200 py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-indigo-400 text-white font-black rounded flex items-center justify-center text-lg shadow-sm shadow-indigo-500/50">
                J
              </div>
        ...
        <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-indigo-900/50 text-center text-xs text-indigo-400/80 flex flex-col sm:flex-row justify-between items-center gap-4">
