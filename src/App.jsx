...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-[#064E3B] selection:text-white">
      
      {/* --- TOP CONTACT BAR --- */}
      <div className="bg-[#064E3B] text-white py-2 px-6">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-lg border-b border-zinc-100 px-6 py-4 transition-all">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <a href="#" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#064E3B] text-white font-black rounded-lg flex items-center justify-center text-xl shadow-md">
              J
            </div>
            <div>
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-zinc-600">
            <a href="#about" className="hover:text-[#064E3B] transition-colors">Our Expertise</a>
            <a href="#portfolio" className="hover:text-[#064E3B] transition-colors">Portfolio</a>
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="hidden lg:block text-sm font-bold text-zinc-500 hover:text-[#064E3B] transition-colors"
            >
              Client Login
            </a>
            <button 
              onClick={() => setIsEstimateModalOpen(true)}
              className="bg-[#064E3B] hover:bg-[#7c290e] text-white font-bold px-6 py-2.5 rounded-full text-sm transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center gap-2"
            >
      ...
      <section className="relative pt-12 pb-20 lg:pt-24 lg:pb-32 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 z-10">
            <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#064E3B] bg-orange-50 px-4 py-2 rounded-full">
            ...
            <h1 className="text-5xl lg:text-7xl font-black text-zinc-900 leading-[1.1] tracking-tight">
              Building Spaces That <span className="text-[#064E3B]">Inspire.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                onClick={() => setIsEstimateModalOpen(true)}
                className="bg-[#064E3B] hover:bg-[#7c290e] text-white font-bold px-8 py-4 rounded-full text-sm transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 text-center"
              >
                Start Your Project
              </button>
              <a 
                href="#portfolio"
                className="bg-white hover:bg-zinc-50 text-zinc-900 border border-zinc-200 font-bold px-8 py-4 rounded-full text-sm transition-all text-center"
              >
                View Portfolio
              </a>
            </div>
          ...
          <div className="relative z-10 lg:ml-auto w-full max-w-md">
            <div className="absolute inset-0 bg-gradient-to-tr from-[#064E3B]/20 to-transparent blur-3xl -z-10 rounded-full"></div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between text-sm font-bold mb-3">
                    ...
                    <span className="text-[#064E3B] text-lg">{heroSqft} Sq.Ft.</span>
                  </div>
                  <input 
                    type="range" 
                    ...
                    className="w-full h-2 bg-zinc-200 rounded-full appearance-none cursor-pointer accent-[#064E3B]"
                  />
                </div>

                <div className="bg-[#064E3B] text-white p-6 rounded-2xl">
                  ...
                  <button 
                    ...
                    className="w-full bg-white text-[#064E3B] font-bold py-3 rounded-xl hover:bg-zinc-50 transition-colors text-sm"
                  >
      ...
      <section id="about" className="py-24 bg-zinc-50 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-[#064E3B] font-bold text-sm tracking-widest uppercase mb-2 block">Our Expertise</span>
      ...
      <section id="portfolio" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-8">
          <div className="max-w-xl">
            <span className="text-[#064E3B] font-bold text-sm tracking-widest uppercase mb-2 block">Featured Work</span>
            ...
            {['All', 'Residential', 'Civil', 'Interiors'].map(filter => (
              <button
                ...
                className={`px-5 py-2.5 text-sm font-bold rounded-full transition-all ${
                  activeFilter === filter ? 'bg-[#064E3B] text-white shadow-md' : 'bg-zinc-100 text-zinc-600 hover:bg-zinc-200'
                }`}
              >
                {filter}
              </button>
            ...
            >
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-2xl font-black text-zinc-900 mb-2 group-hover:text-[#064E3B] transition-colors">{p.title}</h3>
                    <p className="text-sm text-zinc-500 flex items-center gap-1"><MapPin className="w-4 h-4" /> {p.location}</p>
                  </div>
                  <span className="bg-orange-50 text-[#064E3B] text-xs font-bold px-3 py-1 rounded-full">
                    {p.area}
                  </span>
                </div>
                <p className="text-zinc-600 mb-6 line-clamp-2">{p.description}</p>
                <div className="flex items-center text-[#064E3B] font-bold text-sm group-hover:translate-x-2 transition-transform">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex justify-center items-center p-4 bg-zinc-900/80 backdrop-blur-sm">
          <div className="bg-white w-full max-w-3xl max-h-[90vh] rounded-3xl overflow-hidden flex flex-col relative shadow-2xl">
            <button 
              onClick={() => setSelectedProject(null)} 
              className="absolute top-4 right-4 z-10 bg-white/50 hover:bg-white text-zinc-900 p-2 rounded-full backdrop-blur-md transition-colors"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="h-64 sm:h-80 relative shrink-0">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-8">
                <div className="text-white">
                  <span className="bg-[#064E3B] text-white text-xs font-bold px-3 py-1 rounded-full mb-3 inline-block">
            ...
            <div className="p-8 overflow-y-auto flex-1">
              ...
              <div className="bg-orange-50 p-6 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                  <h4 className="font-bold text-[#064E3B]">Want to build something similar?</h4>
                ...
                <button 
                  ...
                  className="w-full sm:w-auto bg-[#064E3B] hover:bg-[#7c290e] text-white px-6 py-3 rounded-full text-sm font-bold transition-all whitespace-nowrap"
                >
                  Get Free Estimate
                </button>
              </div>
          ...
          <div className="bg-white w-full max-w-md p-8 rounded-3xl relative shadow-2xl">
            ...
            {!isLeadSaved ? (
              <>
                ...
                <form onSubmit={handleEstimateSubmit} className="space-y-5">
                  <div>
                    ...
                    <input type="text" required value={leadData.clientName} onChange={e => setLeadData({...leadData, clientName: e.target.value})} placeholder="e.g. Ramesh Varma" className="w-full px-5 py-4 bg-zinc-50 border border-zinc-200 text-zinc-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#064E3B] transition-all" />
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-zinc-700 uppercase mb-2 ml-1">Phone</label>
                      <input type="tel" required value={leadData.phone} onChange={e => setLeadData({...leadData, phone: e.target.value})} placeholder="+91 98765..." className="w-full px-5 py-4 bg-zinc-50 border border-zinc-200 text-zinc-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#064E3B] transition-all" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-zinc-700 uppercase mb-2 ml-1">Area (Sq.Ft)</label>
                      <input type="number" required value={leadData.sqft} onChange={e => setLeadData({...leadData, sqft: e.target.value})} placeholder="2500" className="w-full px-5 py-4 bg-zinc-50 border border-zinc-200 text-zinc-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#064E3B] transition-all" />
                    </div>
                  </div>

                  <div>
                    <label className="block text-xs font-bold text-zinc-700 uppercase mb-2 ml-1">Project Type</label>
                    <select value={leadData.projectType} onChange={e => setLeadData({...leadData, projectType: e.target.value})} className="w-full px-5 py-4 bg-zinc-50 border border-zinc-200 text-zinc-900 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#064E3B] transition-all cursor-pointer">
                  ...
                  <button type="submit" disabled={loading} className="w-full py-4 bg-[#064E3B] hover:bg-[#7c290e] text-white font-bold rounded-full transition-all mt-4 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
              ...
              <div className="py-10 text-center space-y-4">
                <div className="w-16 h-16 bg-emerald-100 text-emerald-600 flex items-center justify-center mx-auto rounded-full mb-6">
                  <CheckCircle2 className="w-8 h-8" />
                </div>
                <h3 className="text-2xl font-black text-zinc-900">Request Received!</h3>
                <p className="text-zinc-600">
                  Based on <span className="font-bold text-zinc-900">{leadData.sqft} Sq.Ft.</span>, your project will range between <span className="font-bold text-[#064E3B]">₹{((parseFloat(leadData.sqft) || 1500) * 1500).toLocaleString('en-IN')}</span> and <span className="font-bold text-[#064E3B]">₹{((parseFloat(leadData.sqft) || 1500) * 1900).toLocaleString('en-IN')}</span>.
                </p>
      ...
      {/* --- CTA SECTION --- */}
      <section className="py-24 bg-[#064E3B] px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <button 
            onClick={() => setIsEstimateModalOpen(true)}
            className="bg-white text-[#064E3B] font-black px-10 py-5 rounded-full text-lg shadow-2xl hover:scale-105 transition-transform"
          >
      ...
      {/* --- FOOTER --- */}
      <footer id="contact" className="bg-zinc-950 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-8 bg-white text-[#064E3B] font-black rounded flex items-center justify-center text-lg">
                J
              </div>
          ...
          <div className="flex flex-col gap-4 text-sm font-semibold text-zinc-300">
            <span className="flex items-center gap-3"><MapPin className="w-4 h-4 text-[#064E3B]" /> 302 Amrutha Lakshmi Residency, Kondapur, Hyderabad, 500084</span>
            <span className="flex items-center gap-3"><Mail className="w-4 h-4 text-[#064E3B]" /> accounts@jyanipur.in</span>
            <span className="flex items-center gap-3"><Phone className="w-4 h-4 text-[#064E3B]" /> +91 9246546742</span>
          </div>
        </div>
